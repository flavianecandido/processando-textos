...
var pontosCentroSP = roteiros[4].split("|")[1].trim().split(";");
document.write('<b>Pontos turísticos localizados Centro da cidade de São Paulo:</b>' + "<br>");
document.write(pontosCentroSP.join("; ") + "<br>");

var pontosDowntown = roteiros[7].split("|")[1].trim().split(";");
document.write('<b>Pontos turísticos localizados Downtown na cidade de Las Vegas:</b>' + "<br>");
document.write(pontosDowntown.join("; ") + "<br>");
