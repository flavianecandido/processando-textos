...
document.write('<br><b>Quantidade de locais citados no Roteiro A de cada cidade:</b>' + "<br>");
document.write(locaisRoteiroA1 + "<br>");


var centrosp = html.split("#")
document.write('<br><b>Pontos turísticos localizados Centro da cidade de São Paulo:</b>' + "<br>")
document.write(centrosp[2])

var downtown = html.split("#")
document.write('<br><b>Pontos turístico localizados Downtown na cidade de Los Angeles:</b>' + "<br>")
